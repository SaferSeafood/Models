...
brm.none.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans, data = fish.reg, prior = c(set_prior("cauchy(0, 0.5)", class = "b")))

brm.habitat.slope.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans + TotalDDT.sed.trans:feeding_position, data = fish.reg, prior = c(set_prior("cauchy(0, 0.5)", class = "b")))

brm.habitat.intercept.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans + feeding_position, data =  fish.reg, prior = c(set_prior("cauchy(0, 0.5)", class = "b")))

brm.diet.slope.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans + TotalDDT.sed.trans:trophic_category, data =fish.reg, prior = c(set_prior("cauchy(0, 0.5)", class = "b")))

brm.diet.intercept.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans + trophic_category, data =fish.reg, prior = c(set_prior("cauchy(0, 0.5)", class = "b")))
...
brm.diet.habitat.species.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans * trophic_category +
                                 TotalDDT.sed.trans * feeding_position + Family, data =fish.reg.fam,
                               prior = c(
                                 set_prior("cauchy(0, 0.5)", class = "b")
                                 #set_prior("cauchy(0, 2)", class = "sd")) remove this
                               ))

brm.diet.habitat.species.year.fam = brm(TotalDDT.trans|cens(Censored, Detection.Limit) ~ TotalDDT.sed.trans * trophic_category +
                                      TotalDDT.sed.trans * feeding_position + Year + Family, data =fish.reg.fam,
                                    prior = c(
                                      set_prior("cauchy(0, 0.5)", class = "b")
                                      #set_prior("cauchy(0, 2)", class = "sd")) remove this
                                    ))
