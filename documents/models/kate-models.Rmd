...
- 
```{r}
fish_dat <- read_csv("/Users/katebecker/Documents/Bren/Capstone/SaferSeafood/data/fish_data/totalDDX_fish_southernCA.csv")
...
Weight Observations 
```{r}
# only 439 observations
# 658 NA's 
summary(fish_dat$WeightAvg.g)
unique(fish_dat$TLAvgLength.mm)
```
...
unique(fish_dat$TLAvgLength.mm)
summary(fish_dat$TLAvgLength.mm)
```
- alot of NAs here can we even find a relationship here? 
