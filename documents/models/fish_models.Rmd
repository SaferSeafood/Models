...
# select station area
fish_location = read.csv(here::here("data","fish_data","totalDDX_fish_southernCA.csv")) %>% 
  dplyr::select(CompositeCompositeID, CompositeStationArea)

# Read in fish data, and join with sediments 
fish_reg = read.csv(here::here("data","fish_data","totalDDT_fish_southernCA.csv")) %>% # Read in fish DDT values 
