...
This document contains code for feature selection using the projpred package. To use this package for feature selection, you set a reference model and then test combinations of predictors to see the minimum amount of predictors that has the same model accuracy.
