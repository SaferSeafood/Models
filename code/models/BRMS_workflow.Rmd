...
This model did not perform as well as brm.diet.habitat.species.year.non, so we will stick with the first model, which includes the same predictors as the client's model.
...
R2.results = lapply(X=list(brm.diet.habitat.species.year.original,
                   brm.diet.habitat.species.year.non,
                   brm.diet.habitat.year.fam.clean), 
                   FUN=bayes_R2)
```
